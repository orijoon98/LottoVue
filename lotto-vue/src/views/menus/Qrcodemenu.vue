      ...
      <table>
        <tr v-for="item in items" :key="item.id">
          ...
          <td class="input-num">
            <div
              :class="{
                yellow: checkNum(item.one) && item.one >= 1 && item.one <= 10,
                blue: checkNum(item.one) && item.one >= 11 && item.one <= 20,
                red: checkNum(item.one) && item.one >= 21 && item.one <= 30,
                gray: checkNum(item.one) && item.one >= 31 && item.one <= 40,
                green: checkNum(item.one) && item.one >= 41 && item.one <= 45,
              }"
              id="one"
              v-html="item.one"
            ></div>
            <div
              :class="{
                yellow: checkNum(item.two) && item.two >= 1 && item.two <= 10,
                blue: checkNum(item.two) && item.two >= 11 && item.two <= 20,
                red: checkNum(item.two) && item.two >= 21 && item.two <= 30,
                gray: checkNum(item.two) && item.two >= 31 && item.two <= 40,
                green: checkNum(item.two) && item.two >= 41 && item.two <= 45,
              }"
              id="two"
              v-html="item.two"
            ></div>
            <div
              :class="{
                yellow:
                  checkNum(item.three) && item.three >= 1 && item.three <= 10,
                blue:
                  checkNum(item.three) && item.three >= 11 && item.three <= 20,
                red:
                  checkNum(item.three) && item.three >= 21 && item.three <= 30,
                gray:
                  checkNum(item.three) && item.three >= 31 && item.three <= 40,
                green:
                  checkNum(item.three) && item.three >= 41 && item.three <= 45,
              }"
              id="three"
              v-html="item.three"
            ></div>
            <div
              :class="{
                ...
                blue: checkNum(item.four) && item.four >= 11 && item.four <= 20,
                red: checkNum(item.four) && item.four >= 21 && item.four <= 30,
                gray: checkNum(item.four) && item.four >= 31 && item.four <= 40,
                green:
            ...
            <div
              :class="{
                ...
                blue: checkNum(item.five) && item.five >= 11 && item.five <= 20,
                red: checkNum(item.five) && item.five >= 21 && item.five <= 30,
                gray: checkNum(item.five) && item.five >= 31 && item.five <= 40,
                green:
            ...
            <div
              :class="{
                yellow: checkNum(item.six) && item.six >= 1 && item.six <= 10,
                blue: checkNum(item.six) && item.six >= 11 && item.six <= 20,
                red: checkNum(item.six) && item.six >= 21 && item.six <= 30,
                gray: checkNum(item.six) && item.six >= 31 && item.six <= 40,
                green: checkNum(item.six) && item.six >= 41 && item.six <= 45,
              }"
              id="six"
              v-html="item.six"
            ></div>
...
export default {
  ...
  methods: {
    ...
    decodeQR() {
      ...
      this.tIndex =
        52 - (parseInt(this.drwNo[52]) - parseInt(str.substr(0, 4)));
